...
Toggle.ZIndex = 2
Toggle.Image = "https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=138179839525478"
...
Indicator.ImageColor3 = Color3.new(0, 0, 0)
...
TextButton_Roundify_4px_3.ImageColor3 = Color3.new(1, 1, 1)
...
Comments.Text = ""
Comments.TextColor3 = Color3.new(1, 1, 1)
...
Globals.Text = ""
Globals.TextColor3 = Color3.new(1, 1, 1)
Globals.TextSize = 15
...
Keywords.Text = ""
Keywords.TextColor3 = Color3.new(1, 1, 1)
...
RemoteHighlight.TextColor3 = Color3.new(1, 1, 1)
...
Strings.Text = ""
Strings.TextColor3 = Color3.new(1, 1, 1)
Strings.TextSize = 15
...
Numbers.Text = ""
Numbers.TextColor3 = Color3.new(1, 1, 1)
Numbers.TextSize = 15
...
TextButton_Roundify_4px_5.ImageColor3 = Color3.new(1, 1, 1)
...
function library:AddWindow(title, options)
		...
		open_close.MouseButton1Click:Connect(function()
			if canopen then
				...
				if open then
					...
					Resize(Window, {Size = UDim2.new(0, Window.AbsoluteSize.X, 0, 55)}, options.tween_time)
	...
	do
		...
		local function updateTabCanvas()
			local total = 0
			for _, child in ipairs(tab_buttons:GetChildren()) do
				if child:IsA("GuiObject") and not child:IsA("UIListLayout") then
					total = total + child.AbsoluteSize.X + 2
				end
			end
			tab_buttons.CanvasSize = UDim2.new(0, math.max(total, tab_buttons.AbsoluteSize.X), 0, 0)
		end
		...
		do
			function window_data:AddTab(tab_name)
				...
				if new_tab:IsA("ScrollingFrame") then
